...
$.ajax({
  ...
  success: function(data) {
    ...
    $.each(info, function (index, employee) {
        ...
        modalBox += '<div class="modal-info-container"><img class="modal-img" src= "' + picture + '" alt="profile picture"><h3 id="name" class="modal-name cap">' + name + '</h3><p class="modal-text">' + email + '</p><p class="modal-text cap">' + location + '</p>';
        modalBox += '<hr>';
        ...
        gallery += '<p class="card-text">' + email + '</p><p class="card-text cap">' + location + '</p>';
        gallery += '</div></div>';
      ...
      $(document).ready( function () {
        card.on('click', function() {
          modalContain,modal.each( function(index){
        ...
        modal,modalContain,modalButton.on('click', function() {
          modal,modalContain.removeClass('active');
        });
      })
